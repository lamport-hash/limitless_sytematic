#!/usr/bin/env python3
"""
Run Outside Bar Candlestick Strategy on QQQ ETF.

Usage:
    python scripts/strat/run_outside_bar.py
    python scripts/strat/run_outside_bar.py --direction long
    python scripts/strat/run_outside_bar.py --direction short --atr_mult 2.5
"""
...
from strat.s_candle_outside_bar import main


def parse_args():
    parser = argparse.ArgumentParser(
        description="Run Outside Bar Candlestick Strategy on QQQ ETF"
    )
    parser.add_argument(
        "--direction",
        type=str,
