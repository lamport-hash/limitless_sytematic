"""
FirstRate ETF dividend-adjusted 1min data normalizer.

Parses 6-column format:
...
def norm_firstrate_etf_div_adj(input_file: str, output_pickle: str) -> Tuple[pd.DataFrame, str, str]:
    """
    Load ETF dividend-adjusted txt file (6-column format) and create DataFrame with normalized column mapping.

    Input format:
        - Column 1: Timestamp (YYYY-MM-DD HH:MM:SS)
        - Column 2-5: Open, High, Low, Close
        - Column 6: Volume
