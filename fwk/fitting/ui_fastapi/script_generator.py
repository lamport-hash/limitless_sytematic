...
def generate_script(config: FittingConfig) -> str:
    lines = [
        ...
        "    Normalizer,",
        ")",
        "from fitting_metrics import MetricType, AveragingType, RegressionMetric, ClassificationMetric",
        "from fitting_models import TimeSeriesModelTrainer",
        "from fitting_hyperparams import HyperparameterTuner, ParamSearchStrat",
        "from fitting_feature_selection import FeatureSelector, FeatureSelectionMethod",
        "from fitting_feature_bundler import FeatureBundlerFactory",
        "from models.model_factory import ModelFactory",
        "from models.model_register import ModelType",
        "",
        "",
        "def main():",
    ]
